...
//	pch->TxBufPtr = &pch->TxBuf[1];
//	pch->TxBufPtr = &pch->TxBuf[2];
//	pch->TxBufPtr = &pch->TxBuf[3];
//	pch->TxBufPtr = &pch->TxBuf[4];
//	pch->TxBufPtr = &pch->TxBuf[5];
//	pch->TxBufPtr = &pch->TxBuf[6];
//	pch->TxBufPtr = &pch->TxBuf[7];
//	pch->TxBufPtr = &pch->TxBuf[8];
//	pch->TxBufPtr = &pch->TxBuf[9];
//	pch->TxBufPtr = &pch->TxBuf[10];
//	pch->TxBufPtr = &pch->TxBuf[11];
//	pch->TxBufPtr = &pch->TxBuf[12];
//	pch->TxBufPtr = &pch->TxBuf[13];
//	pch->TxBufPtr = &pch->TxBuf[14];
//	pch->TxBufPtr = &pch->TxBuf[15];
//	pch->TxBufPtr = &pch->TxBuf[16];
//	pch->TxBufPtr = &pch->TxBuf[17];

//	HAL_UART_Transmit(&huart1,&pch->TxBuf[0],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[1],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[2],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[3],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[4],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[5],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[6],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[7],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[8],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[9],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[10],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[11],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[12],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[13],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[14],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[15],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[16],1,100);
//	HAL_UART_Transmit(&huart1,&pch->TxBuf[17],1,100);
    MB_TxByte(pch);
//    MB_CommRxIntDis(pch);
    MB_CommTxIntEn(pch); 
}
